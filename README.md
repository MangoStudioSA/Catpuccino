...
![Planificacion 1](https://github.com/MangoStudioSA/Catpuccino/blob/main/PhotosGDD/plan1.png)
![Planificacion 2](https://github.com/MangoStudioSA/Catpuccino/blob/main/PhotosGDD/plan2.png)
![Planificacion 3](https://github.com/MangoStudioSA/Catpuccino/blob/main/PhotosGDD/plan3.png)
![Planificacion 4](https://github.com/MangoStudioSA/Catpuccino/blob/main/PhotosGDD/plan4.png)
...
### 8.1 Diseños de los menús
En cuanto al estilo artístico y principios generales de la interfaz, esta tiene una estética cartoon siguiendo el estilo de toda la parte 2D del videojuego. A su vez la paleta de colores son pasteles, algunos de ellos con textura marmolada aportándole interés y profundidad a la interfaz. En cuanto al font de la interfaz se contará con uno efecto burbuja para toda la interfaz.

Algunas interfaces cuentan con animaciones al clickear botones o interactuar con ellas con el objetivo de aportar dinamismo al juego a la vez que se le da vida a la propia interfaz.
