...
public class CursorManager : MonoBehaviour
{
    ...
    public void TakeCuchara()
    {
        ...
        if (miniGameInput.cucharaInHand == true && miniGameInput.coverInHand == false && miniGameInput.iceInHand==false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(cucharaCursorTexture, hotSpotCuchara, CursorMode.Auto);
        }

        if (miniGameInput.cucharaInHand == false && miniGameInput.coverInHand == false && miniGameInput.iceInHand == false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(defaultCursorTexture, hotSpotDefault, CursorMode.Auto);
        }
    }
    ...
    {
        if (miniGameInput.waterInHand == true && miniGameInput.coverInHand == false && miniGameInput.cucharaInHand == false && miniGameInput.iceInHand == false)
        {
            Cursor.SetCursor(aguaCursorTexture, hotSpotAgua, CursorMode.Auto);
        }

        if (miniGameInput.waterInHand == false && miniGameInput.coverInHand == false && miniGameInput.cucharaInHand == false && miniGameInput.iceInHand == false)
        {
            Cursor.SetCursor(defaultCursorTexture, hotSpotDefault, CursorMode.Auto);
        }
    }
    ...
    { 
        if(miniGameInput.iceInHand == true && miniGameInput.cucharaInHand == false && miniGameInput.coverInHand == false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(hieloCucharaCursorTexture, hotSpotHieloCuchara, CursorMode.Auto);
        }

        if (miniGameInput.iceInHand == false && miniGameInput.cucharaInHand == false && miniGameInput.coverInHand == false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(defaultCursorTexture, hotSpotDefault, CursorMode.Auto);
        }
    }
    ...
    {
        if (miniGameInput.coverInHand == true && miniGameInput.cucharaInHand == false && miniGameInput.iceInHand == false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(tapaCursorTexture, hotSpotTapaCuchara, CursorMode.Auto);
        }

        if (miniGameInput.coverInHand == false && miniGameInput.cucharaInHand == false && miniGameInput.iceInHand == false && miniGameInput.waterInHand == false)
        {
            Cursor.SetCursor(defaultCursorTexture, hotSpotDefault, CursorMode.Auto);
        }
    }
